                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-info rounded-circle" onclick="event.preventDefault();
                                document.getElementById('activate-form-{{$doctor->id}}').submit();
                                "><i class="fa fa-check"></i></button>
                            <form id="activate-form-{{$doctor->id}}" method="post"
                                  action="{{ route('admins.activate', $doctor->id) }}"
                                  class="d-none">
                            ...
                            <form id="delete-certificate-form-{{$doctor->id}}" method="post"
                                  action="{{ route('admins.delete', $doctor->id) }}"
                                  class="d-none">
                                @method('DELETE')
                                @csrf
                            </form>
