...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{ route('doctors.submitRegisterForm') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-group mb-3">
                    <input type="text" name="building_number" value="{{ old('building_number') }}" class="form-control" placeholder="Building Number">
                    <div class="input-group-append">
                        <div class="input-group-text">
            ...
            <a href="{{ route('doctors.showLoginForm') }}" class="text-center">I already have a membership</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
